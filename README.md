...
- [x] **Stores data in MongoDB** - Created database.js file with MongoDB connection and CRUD operations for canvases
- [x] **Stores credentials in MongoDB** - User authentication data stored in MongoDB users collection
